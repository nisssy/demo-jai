...
export function CostDialog({ open, onOpenChange, project, costs, onCostsChange, onAutoFill, autoFilled, onSave }: CostDialogProps) {
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-3xl">
        <DialogHeader>
          ...
          <DialogDescription>{project?.projectName} のコスト情報を入力してください</DialogDescription>
        </DialogHeader>
          ...
          <div className="bg-slate-50 p-4 rounded-lg space-y-2">
            ...
            <div className="grid grid-cols-2 gap-3 text-sm">
              ...
              <div>
                ...
                <span className="ml-2 font-medium text-blue-600 text-lg">{project?.estimateAmount}</span>
              </div>
            </div>
          </div>

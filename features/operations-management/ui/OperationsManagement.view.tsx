...
export type OperationsManagementViewProps = {
  projectData: ProjectData
  prGenerated: boolean
  prText: string
  costsAutoFilled: boolean
  complianceStep: number
  ...
  onGeneratePR: () => void
  onAutoFillCosts: () => void
  onComplianceCheck: () => void
  onNext: () => void
  onBack: () => void
}

export const OperationsManagementView = ({
  projectData,
  prGenerated,
  prText,
  costsAutoFilled,
    ...
    <div className="max-w-6xl mx-auto space-y-6">
      ...
      <Card className="p-6 border-2 border-purple-200 bg-purple-50/30">
        ...
        <div className="space-y-4">
          ...
          <Button onClick={onGeneratePR} className="bg-purple-600 hover:bg-purple-700" disabled={isGenerating}>
            {isGenerating ? (
              <>
      ...
      <Card className="p-6">
        ...
        <div className="space-y-4">
          <div className="flex items-center gap-2 mb-4">
            <Button onClick={onAutoFillCosts} variant="outline" className="border-purple-300 bg-transparent">
            ...
            <table className="w-full">
              ...
              <tfoot className="bg-slate-50">
                <tr>
                  ...
                  <td className="p-3 text-right font-bold">¥{totalCost.toLocaleString()}</td>
                </tr>
              </tfoot>
            </table>
          </div>
      ...
      <Card className="p-6 border-2 border-blue-200">
        ...
        <div className="space-y-4">
          ...
          <Button onClick={onComplianceCheck} className="bg-blue-600 hover:bg-blue-700">
            <Sparkles className="w-4 h-4 mr-2" />

...
export type ProjectCorrectionViewProps = {
...
export const ProjectCorrectionView = ({
  projectData,
  localBillingAddress,
  localContractAmount,
  hasAddressError,
    ...
    <div className="max-w-5xl mx-auto space-y-6">
      ...
      <Alert>
        ...
        <AlertDescription>
          ...
          <pre className="text-sm whitespace-pre-wrap font-mono bg-slate-50 p-3 rounded mt-2">{projectData.correctionRequest}</pre>
        </AlertDescription>
      </Alert>

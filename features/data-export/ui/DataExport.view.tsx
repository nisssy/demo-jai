...
export type DataExportViewProps = {
  reportUrl: string
  isScanning: boolean
    ...
    <div className="max-w-6xl mx-auto space-y-6">
        ...
        <div className="space-y-4">
          <div>
            ...
            <div className="flex gap-2">
              <Input value={reportUrl} onChange={(e) => onReportUrlChange(e.target.value)} placeholder="https://example.com/report/..." className="flex-1" />
              <Button onClick={onPublicationCheck} disabled={!reportUrl || isScanning} className="bg-purple-600 hover:bg-purple-700">
                {isScanning ? (
                  <>
      ...
      <Card className="p-6 border-2 border-blue-200">
        ...
        <div className="flex gap-3">
          <Button onClick={onMapping} disabled={isMappingData || dataMapped} className="bg-blue-600 hover:bg-blue-700">

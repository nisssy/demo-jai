...
import { PROPOSAL_STATUS_LABELS, READING_CERTAINTY_OPTIONS } from "@/new/api/lottery-data"
import { CheckCircle } from "lucide-react"
import type { OrderStatus, ExecutionStatus } from "@/new/features/project-registration/model/lottery-types"

const EXECUTION_STATUS_OPTIONS: ExecutionStatus[] = ["実施前", "実施中", "終了"]
    ...
    <div className="space-y-6">
      <div className="space-y-4 border-b pb-5">
        ...
        <div className="space-y-2">
          ...
          <Select value={proposalStatus} onValueChange={(v) => onStatusChange(v as OrderStatus)}>
        ...
        {proposalStatus === "order-received" && (
          <div className="space-y-2 pt-3 border-t">
            ...
            <Select value={executionStatus || "実施前"} onValueChange={(v) => onExecutionStatusChange(v as ExecutionStatus)}>
              <SelectTrigger className="w-48 h-9 text-xs">
                <SelectValue />
              </SelectTrigger>
              <SelectContent>

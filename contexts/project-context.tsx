...
const initialProjects: Product[] = [
  ...
  // 本押さえ依頼のテストデータ
  {
    ...
    statusHistory: [
      ...
      { status: "仮押さえ済み", timestamp: "2025/12/22T16:00:00", changedBy: "イベントチーム", note: "押さえ状況を保存" },
      { status: "営業確認中", timestamp: "2025/12/23T09:00:00", changedBy: "システム", note: "仮押さえ完了により自動更新" },
      { status: "イベントチーム確認中", timestamp: "2025/12/24T11:00:00", changedBy: "営業", note: "営業確認完了" },
      { status: "本押さえ依頼", timestamp: "2025/12/25T15:30:00", changedBy: "イベントチーム", note: "内容確認を完了" },
    ],
    ...getCompanyAndHallInfo("マルハン渋谷店"),
  },
  {
    ...
    statusHistory: [
      ...
      { status: "仮押さえ済み", timestamp: "2025/12/27T14:00:00", changedBy: "イベントチーム", note: "押さえ状況を保存" },
      { status: "営業確認中", timestamp: "2025/12/28T09:00:00", changedBy: "システム", note: "仮押さえ完了により自動更新" },
      { status: "イベントチーム確認中", timestamp: "2025/12/29T11:00:00", changedBy: "営業", note: "営業確認完了" },
      { status: "本押さえ依頼", timestamp: "2025/12/30T16:00:00", changedBy: "イベントチーム", note: "内容確認を完了" },
    ],
    ...getCompanyAndHallInfo("ダイナム新宿店"),
  },
  // 手配進行中のテストデータ
  {
    ...
    statusHistory: [
      ...
      { status: "イベントチーム確認中", timestamp: "2025/12/24T11:00:00", changedBy: "営業", note: "営業確認完了" },
      { status: "本押さえ依頼", timestamp: "2025/12/25T15:30:00", changedBy: "イベントチーム", note: "内容確認を完了" },
      { status: "手配進行中", timestamp: "2025/12/26T10:00:00", changedBy: "イベントチーム", note: "押さえ状況を保存" },
    ],
    ...getCompanyAndHallInfo("マルハン渋谷店"),
  },
  {
    ...
    statusHistory: [
      ...
      { status: "イベントチーム確認中", timestamp: "2025/12/29T11:00:00", changedBy: "営業", note: "営業確認完了" },
      { status: "本押さえ依頼", timestamp: "2025/12/30T16:00:00", changedBy: "イベントチーム", note: "内容確認を完了" },
      { status: "手配進行中", timestamp: "2026/01/02T10:00:00", changedBy: "イベントチーム", note: "押さえ状況を保存" },
    ],
    ...getCompanyAndHallInfo("ダイナム新宿店"),
  },
  {
    ...
    statusHistory: [
      ...
      { status: "仮押さえ済み", timestamp: "2026/01/03T15:00:00", changedBy: "イベントチーム", note: "押さえ状況を保存" },
      { status: "営業確認中", timestamp: "2026/01/04T09:00:00", changedBy: "システム", note: "仮押さえ完了により自動更新" },
      { status: "イベントチーム確認中", timestamp: "2026/01/05T13:00:00", changedBy: "営業", note: "営業確認完了" },
      { status: "本押さえ依頼", timestamp: "2026/01/06T14:30:00", changedBy: "イベントチーム", note: "内容確認を完了" },
      { status: "手配進行中", timestamp: "2026/01/07T10:00:00", changedBy: "イベントチーム", note: "押さえ状況を保存" },
    ],
    ...getCompanyAndHallInfo("ガイア池袋店"),
  },
